...
- [Disable-Android-Pie-Screen-Rotation-Suggestion-Button](/dev/Android/Disable-Android-Pie-Screen-Rotation-Suggestion-Button)

### Atom
- [Atom-Python-package](/dev/Atom/Atom-Python-package)
- [Atom-Themes-and-Editor](/dev/Atom/Atom-Themes-and-Editor)
...
### AWS
 ...
 - [Replace-nginx-conf-configuration-with-Elastic-Beanstalk-ebextensions](/dev/AWS/Replace-nginx-conf-configuration-with-Elastic-Beanstalk-ebextensions)
 - [VPC-endpoint-settings-when-running-ElasticBeanstalk-EC2-instances-in-a-private-subnet](/dev/AWS/VPC-endpoint-settings-when-running-ElasticBeanstalk-EC2-instances-in-a-private-subnet)
 - [Setting-up-Load-Balancer-http-to-https-redirection-in-ElasticBeanstalk](/dev/AWS/Setting-up-Load-Balancer-http-to-https-redirection-in-ElasticBeanstalk)
 - [Things-to-know-when-using-Elastic-Beanstalk-in-a-VPC-environment](/dev/AWS/Things-to-know-when-using-Elastic-Beanstalk-in-a-VPC-environment)

### Database
- [17-things-you-shouldnt-do-while-using-MySQL](/dev/Database/17-things-you-shouldnt-do-while-using-MySQL)

### DDD
- [Elements-of-DDD-Effective-Modeling](/dev/DDD/Elements-of-DDD-Effective-Modeling)
...
- [JSConf-korea-2019](/dev/Summary/JSConf-korea-2019)
- [Serverless-Social-Media-Development-with-React-RTFM-2016](/dev/Summary/Serverless-Social-Media-Development-with-React-RTFM-2016)
- [Stable-AWS-Serverless-service](/dev/Summary/Stable-AWS-Serverless-service)
- [Becoming-a-Bright-Developer-by-MeltingPot-Young-community-2017](/dev/Summary/Becoming-a-Bright-Developer-by-MeltingPot-Young-community-2017)
- [Wide-and-Thin-Habits-for-Intelligent-Programming-Kakao-Seo-Ji-yeon](/dev/Summary/Wide-and-Thin-Habits-for-Intelligent-Programming-Kakao-Seo-Ji-yeon)
- [One-person-startup-and-functional-programming-Park-Mi-jung](/dev/Summary/One-person-startup-and-functional-programming-Park-Mi-jung)

### Terminal 
- [CLI-command-to-change-EUCKR-encoding-to-UTF8](/dev/Terminal/CLI-command-to-change-EUCKR-encoding-to-UTF8)
- [hyper-js-personalization-configuration-file](/dev/Terminal/hyper-js-personalization-configuration-file)
- [tmux-beginner](/dev/Terminal/tmux-beginner)
- [useful-plugins-after-install-zsh](/dev/Terminal/useful-plugins-after-install-zsh)
- [Open-JIRA-issue-directly-from-the-terminal-to-Chrome](/dev/Terminal/Open-JIRA-issue-directly-from-the-terminal-to-Chrome)

### Ubuntu
- [Install-Ubuntu-on-your-Dell-laptop-and-what-else-you-need-to-do](/dev/Ubuntu/Install-Ubuntu-on-your-Dell-laptop-and-what-else-you-need-to-do)
- [Adjust-swapfile-applied-from-Ubuntu-1704](/dev/Ubuntu/Adjust-swapfile-applied-from-Ubuntu-1704)
...
- [Configuring-eslint-es6-airbnb-in-Syntastic-Plugin-in-vim](/dev/Vim/Configuring-eslint-es6-airbnb-in-Syntastic-Plugin-in-vim)

### VsCode
- [vscode-initial-settings-and-recommended-plugins](/dev/VsCode/vscode-initial-settings-and-recommended-plugins)
- [vscode-personalization-settings-json](/dev/VsCode/vscode-personalization-settings-json)

### WAS
- [Heading-Apache-Bitnami-SSL-Settings](/dev/WAS/Heading-Apache-Bitnami-SSL-Settings)
...
### Kafka
- [kafka-consumer-group-offset-commit-error-reasons-and-solutions](/ko/dev/Kafka/kafka-consumer-group-offset-commit-error-reasons-and-solutions)

### Etc
- [hls-streaming-and-m3u8-file](/ko/dev/Etc/hls-streaming-and-m3u8-file)
